...
INSERT INTO "new_Character" ("class", "created_at", "gender", "id", "last_login", "level", "nickname", "updated_at", "user_id") SELECT "class", "created_at", "gender", "id", "last_login", "level", "nickname", "updated_at", "user_id" FROM "Character";
