...
export const getClassSkills = (characterClass: CharacterClass) => {
    switch (characterClass) {
        case CharacterClass.BARBARIAN:
            return getBarbarianSkills();
        case CharacterClass.BARD:
            return getBardSkills();
        case CharacterClass.CLERIC:
            return getClericSkills();
        case CharacterClass.FIGHTER:
            return getFighterSkills();
        case CharacterClass.RANGER:
            return getRangerSkills();
        case CharacterClass.ROGUE:
            return getRogueSkills();
        case CharacterClass.WIZARD:
            return getWizardSkills();
        default:
            return [];
    }
};
