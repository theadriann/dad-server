...
import {
    ...
    sc2sCustomizeItemMountReq,
    ss2cCustomizeItemMountRes,
    sc2sCustomizeItemUnmountReq,
    ss2cCustomizeItemUnmountRes,
    sc2sCustomizeEmoteMountReq,
    ss2cCustomizeEmoteMountRes,
    sc2sCustomizeEmoteUnmountReq,
    ss2cCustomizeEmoteUnmountRes,
    sc2sCustomizeActionMountReq,
    ss2cCustomizeActionMountRes,
...
import {
    sc2sRankingRangeReq,
    ss2cRankingRangeRes,
    sc2sRankingNearbyReq,
    ss2cRankingNearbyRes,
    sc2sRankingCharacterReq,
    ss2cRankingCharacterRes,
} from "@/protos/ts/Ranking";
import {
    sc2sShopCharacterSkinListReq,
    ss2cShopCharacterSkinListRes,
    sc2sShopItemSkinListReq,
    ss2cShopItemSkinListRes,
    sc2sShopEmoteListReq,
    ss2cShopEmoteListRes,
    sc2sShopActionListReq,
    ss2cShopActionListRes,
    sc2sShopLobbyEmoteListReq,
    ss2cShopLobbyEmoteListRes,
    sc2sShopCharacterSkinBuyReq,
    ss2cShopCharacterSkinBuyRes,
    sc2sShopItemSkinBuyReq,
    ss2cShopItemSkinBuyRes,
    sc2sShopEmoteBuyReq,
    ss2cShopEmoteBuyRes,
    sc2sShopActionBuyReq,
    ss2cShopActionBuyRes,
    sc2sShopLobbyEmoteBuyReq,
    ss2cShopLobbyEmoteBuyRes,
} from "@/protos/ts/Shop";
import {
    sc2sTradeAnswerReq,
...
export function packTypeToObjType(object: PacketCommand): any {
    switch (object) {
        ...
        case PacketCommand.C2S_LOBBY_ENTER_COUPON_CODE_REQ:
            return sc2sLobbyEnterCouponCodeReq;
        case PacketCommand.S2C_LOBBY_ENTER_COUPON_CODE_RES:
            return ss2cLobbyEnterCouponCodeRes;
        ...
        case PacketCommand.C2S_RANKING_NEARBY_REQ:
            return sc2sRankingNearbyReq;
        case PacketCommand.S2C_RANKING_NEARBY_RES:
            return ss2cRankingNearbyRes;
        ...
        case PacketCommand.S2C_HACK_CHECK_DLL_LIST_NOT:
            return ss2cHackCheckDllListNot;
...
//
// const fileName = `create_del_char_out`;
// const inputFile = fs.readFileSync(`${__dirname}/_input/${fileName}.hex`);

// dumpContext.dumpIndex = 0;
// dumpContext.dumpPath = `resolved_dumps/${fileName}`;

// reportPackets(inputFile.toString("ascii"));
